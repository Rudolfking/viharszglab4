...
public class Skeleton {
    /**
     * Szkeleton main függvénye. Konzolon vagy fájlból adott bemenetek alapján teszteli a különböző eseteket.
     *
     * @param args parancssori argumentumok - input fájl neve
     */
        ...
        try {
            ...
            if (fileName.compareTo("") != 0) {
                ...
                if (str.compareTo("1") == 0) {
                    ...
                    try {
                        while (fileName.equals("")) fileName = in.readLine();
                        input.setInput(new BufferedReader(new FileReader(fileName)));
                        if (!silent) input.setEcho(true);
                    } catch (IOException e) {
                        e.printStackTrace();
